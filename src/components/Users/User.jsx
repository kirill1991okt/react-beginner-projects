...
export const User = ({id,email,first_name,last_name,avatar, onClickToInvited, isInvited}) => (
  <li key={id}>
    <div>
    ...
    <img onClick={() => onClickToInvited(id)} className="action" src={`/assets/${isInvited ? 'minus' : 'plus'}.svg`} alt="Action" />
  </li>
);
